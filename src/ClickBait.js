 ...
 */
window.ClickBaitJS = {};
window.ClickBaitJS.insertBait = (element) => {
  ...
  element.innerHTML = `<div class="bait-img"><img src="https://image.pollinations.ai/prompt/(SFW)${encodeURIComponent(headline)}?width=500&height=500" loading="lazy" alt=""/></div><div class="bait-content">
<h4>SPONSORED</h4>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    [].slice.call(slots).map(ClickBaitJS.insertBait);
});
